...
class myAES(object):
    ...
    def __init__(self):
        ...
        self.S = SB
        self.SR = [0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11]
        self.RCON = [0x8d, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36]
        self.key = [0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f, 0x70]
        # print("".join("%02x" % _ for _ in self.key))
        # print ""
    ...
    def expandKey(self, key):
        ...
        for i in range(10):
            ...
            subKeys += [curr]
            # print("".join("%02x" % _ for _ in curr))
        return subKeys
    ...
    def encrypt(self, plaintext):
        ...
        for rnd in range(10):
            ...
            # print("".join("%02x" % _ for _ in ciphertext))
            ciphertext = [ self.S[ciphertext[self.SR[i]]] for i in range(16) ]
            # print("".join("%02x" % _ for _ in ciphertext))
            if rnd==9: break
...
cipher = myAES()
res = cipher.encrypt([0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f, 0x70])
# print ""
print("".join("%02x" % _ for _ in res))
